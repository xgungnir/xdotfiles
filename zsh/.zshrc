...
alias killteams="killall -9 'Microsoft Teams'"
alias v='nvim'
...
if [[ "$(uname -m)" == "x86_64" ]]; then
  alias gpuSet0='sudo pmset -b gpuswitch 0'
  alias gpuSet1='sudo pmset -b gpuswitch 1'
  alias gpuSet2='sudo pmset -b gpuswitch 2'
fi
